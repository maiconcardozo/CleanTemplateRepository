                ...
                options.DocInclusionPredicate((docName, apiDescription) =>
                {
                    ...
                    return docName switch
                    {
                        ...
                        ApplicationConstants.Api.SwaggerDefinitions.AccessControl =>
                            ...
                            controllerName?.Equals(ResourceStartup.ApplicationController, StringComparison.OrdinalIgnoreCase) == true ||
                            controllerName?.Equals(ResourceStartup.ApplicationClaimController, StringComparison.OrdinalIgnoreCase) == true,
                        _ => false,
                    };
                });
            });
