...
namespace Authentication.API.Controllers
{
    ...
    public class ActionController : ControllerBase
    {
        ...
        private readonly IValidator<ActionPayLoadDTO> _validator;
        ...
        /// </summary>
        /// <param name="id">ID of the action to update</param>
        ...
        [SwaggerResponseExample(StatusCodes.Status404NotFound, typeof(ProblemDetailsNotFoundExample))]
        [SwaggerResponseExample(StatusCodes.Status500InternalServerError, typeof(ProblemDetailsInternalServerErrorExample))]
        public IActionResult UpdateAction(int id, [FromBody] ActionPayLoadDTO actionDTO, [FromServices] IServiceProvider serviceProvider)
        {
            // Validate the DTO using FluentValidation
            var validationResult = _validator.Validate(actionDTO);
            if (!validationResult.IsValid)
