...
public class ActionControllerTests : IClassFixture<AuthenticationWebApplicationFactory>
{
    ...
    {
        // Act
        var response = await client.GetAsync("/Action/GetActions");
    ...
    {
        // Act
        var response = await client.GetAsync($"/Action/GetActionById/{id}");
    ...
    public async Task AddAction_WithValidData_ShouldReturnExpectedStatusCode()
    {
        ...
        // Act
        var response = await client.PostAsync("/Action/AddAction", content);
    ...
    public async Task UpdateAction_WithNonExistentId_ShouldReturnNotFound()
    {
        ...
        // Act
        var response = await client.PutAsync("/Action/UpdateAction", content);
    ...
    public async Task DeleteAction_WithNonExistentId_ShouldReturnNotFound()
    {
        ...
        // Act
        var response = await client.DeleteAsync($"/Action/DeleteAction/{nonExistentId}");
