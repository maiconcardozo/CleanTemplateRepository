...
namespace Authentication.Tests.Unit
{
    ...
    {
        private readonly ClaimActionPayloadValidator validator;

        public ClaimActionPayloadValidatorTests()
        {
            validator = new ClaimActionPayloadValidator();
        }
        ...
        {
            // Arrange
            var model = new ClaimActionPayLoadDTO { IdClaim = 999999, IdAction = 999999 };
