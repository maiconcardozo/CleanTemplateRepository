...
namespace Authentication.Tests.Unit
{
    public class AccountServiceTests
    {
        ...
        public void GetAllAccounts_WhenCalled_ShouldReturnAllAccountsFromRepository()
        {
            ...
            _mockAccountRepository.Verify(x => x.GetAll(), Times.Once);
        }
        ...
        {
            // Arrange
            _mockAccountRepository.Setup(x => x.GetAll()).Returns(new List<Account>());
        ...
        public void GetAccountByUserName_WithExistingUserName_ShouldReturnAccount()
        {
            ...
            _mockAccountRepository.Setup(x => x.GetByUserName(userName)).Returns(expectedAccount);
            ...
            _mockAccountRepository.Verify(x => x.GetByUserName(userName), Times.Once);
        }
        ...
        public void GetAccountByUserName_WithNonExistingUserName_ShouldReturnNull()
        {
            ...
            _mockAccountRepository.Setup(x => x.GetByUserName(userName)).Returns((Account?)null);
        ...
        public async Task GetAccountByUserNameAsync_WithExistingUserName_ShouldReturnAccount()
        {
            ...
            var userName = "testuser";
            var expectedAccount = new Account { Id = 1, UserName = userName, Password = "hashedpassword" };
            _mockAccountRepository.Setup(x => x.GetByUserNameAsync(userName)).ReturnsAsync(expectedAccount);
            ...
            // Assert
            result.Should().BeEquivalentTo(expectedAccount);
            _mockAccountRepository.Verify(x => x.GetByUserNameAsync(userName), Times.Once);
        }
        ...
        public async Task GetAccountByUserNameAsync_WithNonExistingUserName_ShouldReturnNull()
        {
            // Arrange
            var userName = "nonexistentuser";
            _mockAccountRepository.Setup(x => x.GetByUserNameAsync(userName)).ReturnsAsync((Account?)null);
        ...
        #region GetAccountByUserNameAndPassword Tests
        ...
        public void GetAccountByUserNameAndPassword_WithValidCredentials_ShouldReturnAccount()
        {
            ...
            _mockAccountRepository.Setup(x => x.GetByUserName(inputAccount.UserName)).Returns(storedAccount);
            ...
            System.Action act = () => _accountService.GetAccountByUserNameAndPassword(inputAccount);
        ...
        public void GetAccountByUserNameAndPassword_WithNonExistingUser_ShouldThrowInvalidOperationException()
        {
            ...
            _mockAccountRepository.Setup(x => x.GetByUserName(inputAccount.UserName)).Returns((Account?)null);
            ...
            _mockAccountRepository.Verify(x => x.GetByUserName(inputAccount.UserName), Times.Once);
        }
        ...
        public void GetById_WithExistingId_ShouldReturnAccount()
        {
            ...
            _mockAccountRepository.Setup(x => x.GetById(accountId)).Returns(expectedAccount);
        ...
        public void GetAccountsByIds_WithValidIds_ShouldReturnMatchingAccounts()
        {
            ...
            _mockAccountRepository.Setup(x => x.Find(It.IsAny<Expression<Func<Account, bool>>>()))
                .Returns(expectedAccounts);

            // Act
            var result = _accountService.GetAccountsByIds(accountIds);

            // Assert
            result.Should().BeEquivalentTo(expectedAccounts);
            _mockAccountRepository.Verify(x => x.Find(It.IsAny<Expression<Func<Account, bool>>>()), Times.Once);
        }
        ...
        public void AddAccount_WithNewUserName_ShouldAddAccountSuccessfully()
        {
            ...
            _mockAccountRepository.Setup(x => x.Add(newAccount));
            ...
            _mockAccountRepository.Verify(x => x.Add(It.Is<Account>(a => a.UserName == "newuser")), Times.Once);
        }
        ...
        public void AddAccount_WithDuplicateUserName_ShouldThrowConflictException()
        {
            ...
            _mockAccountRepository.Setup(x => x.GetByUserName(newAccount.UserName)).Returns(existingAccount);

            // Act
            System.Action act = () => _accountService.AddAccount(newAccount);

            // Assert
            act.Should().Throw<ConflictException>()
                .WithMessage(ResourceLogin.DuplicateUserName);
            _mockAccountRepository.Verify(x => x.GetByUserName(newAccount.UserName), Times.Once);
            _mockAccountRepository.Verify(x => x.Add(It.IsAny<Account>()), Times.Never);
        }
        ...
        public void UpdateAccount_WithUniqueUserName_ShouldUpdateSuccessfully()
        {
            ...
            _mockUnitOfWork.Setup(x => x.ExecuteInTransaction(It.IsAny<System.Action>())).Callback<System.Action>(action => action());
            _mockAccountRepository.Setup(x => x.Update(accountToUpdate));
            ...
            _mockAccountRepository.Verify(x => x.Update(It.Is<Account>(a => a.Id == 1 && a.UserName == "maiconca1")), Times.Once);
        }
        ...
        public void UpdateAccount_WithDuplicateUserNameFromDifferentAccount_ShouldThrowConflictException()
        {
            ...
            // Act
            System.Action act = () => _accountService.UpdateAccount(accountToUpdate);
        ...
        public void UpdateAccount_WithSameAccountUserName_ShouldAllowUpdate()
        {
            ...
            // Assert
            _mockAccountRepository.Verify(x => x.GetByUserName(accountToUpdate.UserName), Times.Once);
            _mockAccountRepository.Verify(x => x.Update(It.Is<Account>(a => a.Id == 1 && a.UserName == "sameuser")), Times.Once);
        }
        ...
        public void DeleteAccount_ByEntity_ShouldCallRepositoryRemove()
        {
            ...
            // Assert
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.Remove(accountToDelete), Times.Once);
        }
        ...
        public void DeleteAccount_ById_ShouldGetAccountAndRemove()
        {
            ...
            _mockAccountRepository.Setup(x => x.GetById(accountId)).Returns(accountToDelete);
            _mockUnitOfWork.Setup(x => x.ExecuteInTransaction(It.IsAny<System.Action>()))
                .Callback<System.Action>(action => action());
        ...
        public void DeleteAccount_ByIdWhenAccountNotFound_ShouldNotCallRemove()
        {
            ...
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.GetById(accountId), Times.Once);
            _mockAccountRepository.Verify(x => x.Remove(It.IsAny<Account>()), Times.Never);
        }
        ...
        public void DeleteAccountByUserName_WithExistingUser_ShouldCallRepositoryDelete()
        {
            ...
            // Act
            _accountService.DeleteAccountByUserName(userName);

            // Assert
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.DeleteByUserName(userName), Times.Once);
        }

        #endregion

        #region GetAccounts with Predicate Tests
        ...
        public void GetAccounts_WithValidPredicate_ShouldReturnFilteredResults()
        {
            ...
            _mockAccountRepository.Setup(x => x.Find(predicate)).Returns(expectedAccounts);

            // Act
            var result = _accountService.GetAccounts(predicate);

            // Assert
            result.Should().BeEquivalentTo(expectedAccounts);
            _mockAccountRepository.Verify(x => x.Find(predicate), Times.Once);
        }
        ...
        public void GetSingleOrDefaultAccount_WithPredicateMatchingOne_ShouldReturnSingleAccount()
        {
            ...
            _mockAccountRepository.Setup(x => x.Find(predicate)).Returns(accountList);

            // Act
            var result = _accountService.GetSingleOrDefaultAccount(predicate);
        ...
        public void GetSingleOrDefaultAccount_WithPredicateMatchingNone_ShouldReturnNull()
        {
            ...
            _mockAccountRepository.Setup(x => x.Find(predicate)).Returns(emptyList);
        ...
        public void AddAccounts_WithMultipleAccounts_ShouldCallRepositoryAddRange()
        {
            ...
            // Act
            _accountService.AddAccounts(accountsToAdd);

            // Assert
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.AddRange(accountsToAdd), Times.Once);
        }
        ...
        public void DeleteAccounts_WithMultipleAccounts_ShouldCallRepositoryRemoveRange()
        {
            ...
            // Act
            _accountService.DeleteAccounts(accountsToDelete);

            // Assert
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.RemoveRange(accountsToDelete), Times.Once);
        }
        ...
        public void DeleteAccountsByUserNames_WithMultipleUserNames_ShouldCallRepositoryDelete()
        {
            ...
            // Act
            _accountService.DeleteAccountsByUserNames(userNamesToDelete);

            // Assert
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.DeleteByUserNameList(userNamesToDelete), Times.Once);
        }

        #endregion

        #region UpdatePassword and UpdateUserName Tests
        ...
        public void UpdateAccountPassword_WithValidData_ShouldCallRepositoryUpdate()
        {
            ...
            // Act
            _accountService.UpdateAccountPassword(userName, newPassword);

            // Assert
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.UpdatePassword(userName, newPassword), Times.Once);
        }
        ...
        public void UpdateAccountUserName_WithValidData_ShouldCallRepositoryUpdate()
        {
            ...
            // Act
            _accountService.UpdateAccountUserName(oldUserName, newUserName);

            // Assert
            _mockUnitOfWork.Verify(x => x.ExecuteInTransaction(It.IsAny<System.Action>()), Times.Once);
            _mockAccountRepository.Verify(x => x.UpdateUserName(oldUserName, newUserName), Times.Once);
        }
