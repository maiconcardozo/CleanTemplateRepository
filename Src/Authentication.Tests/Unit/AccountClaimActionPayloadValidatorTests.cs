...
namespace Authentication.Tests.Unit
{
    ...
    {
        private readonly AccountClaimActionPayloadValidator validator;

        public AccountClaimActionPayloadValidatorTests()
        {
            validator = new AccountClaimActionPayloadValidator();
        }
        ...
        {
            // Arrange
            var model = new AccountClaimActionPayLoadDTO { IdAccount = 999999, IdClaimAction = 999999 };
