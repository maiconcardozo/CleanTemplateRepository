...
namespace Authentication.Tests.Unit
{
    ...
    {
        private readonly ClaimPayloadValidator _validator;

        public ClaimPayloadValidatorTests()
        {
            _validator = new ClaimPayloadValidator();
        }
        ...
        public void Model_WithDifferentEnumValues_ShouldValidateCorrectly()
        {
            ...
            var permissionResult = _validator.TestValidate(permissionModel);
            ...
            var roleResult = _validator.TestValidate(roleModel);
            ...
            var customResult = _validator.TestValidate(customModel);
