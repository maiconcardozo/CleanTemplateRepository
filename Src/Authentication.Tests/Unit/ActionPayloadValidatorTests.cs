...
namespace Authentication.Tests.Unit
{
    ...
    {
        private readonly ActionPayloadValidator _validator;

        public ActionPayloadValidatorTests()
        {
            _validator = new ActionPayloadValidator();
        }
        ...
        {
            // Arrange
            var model = new ActionPayLoadDTO { Name = "ValidActionName", CreatedBy = "testuser" };
