...
namespace Authentication.Tests.Unit
{
    ...
    {
        private readonly AccountPayloadValidator _validator;
        ...
        {
            // Arrange
            var model = new AccountPayLoadDTO { UserName = "", Password = "" };
        ...
        public void CreatedBy_WhenEmpty_ShouldHaveValidationError()
        {
            ...
            result.ShouldHaveValidationErrorFor(x => x.CreatedBy)
                .WithErrorMessage("CreatedBy is required for audit tracking.");
        }

        [Fact]
        public void CreatedBy_WhenValid_ShouldNotHaveValidationError()
        {
            // Arrange
            var model = new AccountPayLoadDTO 
            { 
