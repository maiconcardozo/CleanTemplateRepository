...
namespace Authentication.Login.Services.Implementation
{
    ...
    public class AccountService : IAccountService
    {
        ...
        {
            return unitOfWork.AccountRepository.GetByUserName(userName);
        }

        public async Task<Account?> GetAccountByUserNameAsync(string userName)
        {
            return await unitOfWork.AccountRepository.GetByUserNameAsync(userName);
        }
        ...
        public Account GetAccountByUserNameAndPassword(Account account)
        {
            ...
            var dbAccount = unitOfWork.AccountRepository.GetByUserName(account.UserName);
        ...
        {
            return unitOfWork.AccountRepository.Get(account);
        }

        public IEnumerable<Account> GetAccountsByIds(Account account)
        {
            return unitOfWork.AccountRepository.GetByLstId(account);
        }
        ...
        {
            return unitOfWork.AccountRepository.Find(predicate);
        }

        public Account? GetSingleOrDefaultAccount(Expression<Func<Account, bool>> predicate)
        {
            return unitOfWork.AccountRepository.Find(predicate).SingleOrDefault();
        }
        ...
        public void AddAccount(Account account)
        {
            ...
            var existingAccount = unitOfWork.AccountRepository.GetByUserName(account.UserName);
        ...
        public void UpdateAccountPassword(string userName, string newPassword)
        {
            unitOfWork.ExecuteInTransaction(() =>
            {
                unitOfWork.AccountRepository.UpdatePassword(userName, newPassword);
            });
        }
        ...
        public void UpdateAccountUserName(string oldUserName, string newUserName)
        {
            unitOfWork.ExecuteInTransaction(() =>
            {
                unitOfWork.AccountRepository.UpdateUserName(oldUserName, newUserName);
            });
        }
        ...
        public void DeleteAccountByUserName(string userName)
        {
            unitOfWork.ExecuteInTransaction(() =>
            {
                unitOfWork.AccountRepository.DeleteByUserName(userName);
            });
        }
        ...
        public void DeleteAccountsByUserNames(IEnumerable<string> userNames)
        {
            unitOfWork.ExecuteInTransaction(() =>
            {
                unitOfWork.AccountRepository.DeleteByUserNameList(userNames);
            });
        }
        ...
        public void DeleteAccounts(IEnumerable<Account> accounts)
        {
            unitOfWork.ExecuteInTransaction(() =>
              {
                  unitOfWork.AccountRepository.RemoveRange(accounts);
              });
        }
        ...
        {
            return unitOfWork.AccountRepository.GetById(id);
        }

        public IEnumerable<Account> GetAccountsByIds(IEnumerable<int> accountIds)
        {
            return unitOfWork.AccountRepository.Find(a => accountIds.Contains(a.Id));
        }
